...
export function LoginPage() {
  ...
  const result = INPUTS.map(INPUTS => {
    ...
    <input className='login-input' id={INPUTS.name} name={INPUTS.name} required type={INPUTS.name === 'Password' ? type : 'text'}
      pattern={INPUTS.pattern} placeholder={INPUTS.placeholder} onChange={(e) => {
    ...
    <div className='login-page'>
      ...
      <form className='login-form'>
        ...
        <div>
          ...
          <input className='login-input' id='hide' type='checkbox' checked={checked} onChange={() => {
